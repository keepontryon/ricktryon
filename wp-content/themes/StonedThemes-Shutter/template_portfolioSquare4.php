<?php
/*
Template Name:Portfolio Squar4
*/
/*Loadmore Loop*/
 			...
 			if(isset($_POST["paged"])):			
			   ...
			   $post_per_page = get_field('post_per_page');
				...
				while ($the_Query->have_posts()):
					...
					?>		
						<div class="item col-xs-12 <?php $col = $columns; if($col == 2){echo "col-md-6";}elseif($col == 3){echo "col-md-4";}elseif($col == 4){echo "col-md-3";} ?>" like-sort="<?php echo get_post_meta($post->ID,'stoned_like',true);?>" data-time="<?php the_time('Y/m/d g:i:s')?>">
							<div class="mosaic-16-9">
								<div class="mosaic-inside">
									<div class="overlay-container">
										...
										<?php    $large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'portfolio-square4'); ?>
...
<div class="main_container scroll">
	...
	<div class="<?php if($layout=='fullwidth'){echo "fluid-container";}else{echo "container";} ?> portfolio">
