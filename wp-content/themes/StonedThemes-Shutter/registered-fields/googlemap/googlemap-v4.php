...
class acf_field_googlemap extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'googlemap';
		$this->label = __('Google Map','sth_lang');
	...
	*/
	...
	function input_admin_head()
	{
        ...
        <?php if(get_field('google_maps_api_key','options')){ ?>
         <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo get_field('google_maps_api_key','options');?>" type="text/javascript"></script>
        <?php }else{ ?>
