...
function stonedthemes_woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	<div class="minicart pull-right">
		<ul class="list-unstyled">
			<li><a href="<?php echo WC()->cart->get_cart_url(); ?>" class="cart-info"><span><?php echo WC()->cart->get_cart_total(); ?></span> - <?php echo sprintf (_n( '%d item', '%d items', WC()->cart->get_cart_contents_count(),'sth_lang' ), WC()->cart->get_cart_contents_count() ); ?></a></li>
			<li><a href="<?php echo wp_login_url(); ?>" class="sign">Sign In</a></li>
		</ul>
		<div class="minicart-container">
			<a href="<?php echo WC()->cart->get_cart_url(); ?>" title="<?php esc_html_e( 'View your shopping cart' ,'sth_lang'); ?>" class="cart-button">
...
function st_mini_cart(){
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<li class="<?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
							...
							esc_html__( 'Remove this item', 'sth_lang' ),
							esc_attr( $product_id ),
	...
	<?php else : ?>
		...
		<li class="empty"><?php esc_html_e( 'No products in the cart.', 'sth_lang' ); ?></li>
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="total"><strong><?php esc_html_e( 'Subtotal', 'sth_lang' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>

	<?php do_action( 'woocommerce_widget_shopping_cart_before_buttons' ); ?>

	<p class="buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button wc-forward"><?php esc_html_e( 'View Cart', 'sth_lang' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward"><?php esc_html_e( 'Checkout', 'sth_lang' ); ?></a>
	</p>
